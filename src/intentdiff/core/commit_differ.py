...
Usage::
    ...
    from intentdiff import CommitDiffer, DiffConfig
...
from intentdiff.core.models import CommitDiff, CrossFileChange, DiffConfig, SemanticDiff
...
from intentdiff.plugins.exceptions import PluginError, PluginNotFoundError
from intentdiff.sources.git_source import iter_changed_sources
from intentdiff.vcs.base import VcsBackend
    ...
    def _collect_gitignore_state(
        ...
        * ``gitignore_spec`` — a compiled ``pathspec.PathSpec`` built from the
        ...
        try:
            ...
            from intentdiff.sources.git_source import _parse_name_status_z
            from intentdiff.vcs.git_cli import resolve_repo_root, run_git_bytes
