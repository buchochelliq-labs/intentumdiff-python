"""
intentdiff.analysis.text_review
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
from intentdiff.core.models import Change, ChangeGroup
...
def normalize_generic_text_for_review(
    ...
    exist, IntentDiff still works". The full port lives in ``text_review_generic.rs``.
    """
    from intentdiff.rust_core import try_rust_generic_text_review
