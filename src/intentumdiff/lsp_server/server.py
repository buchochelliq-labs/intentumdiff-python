...
from intentumdiff.lsp_server._handlers import (
    _ServerState,
    _do_diff,
    schedule_diff,
    uri_to_path,
...
def create_server(
    ...
    # ------------------------------------------------------------------
    # Custom request: intentumdiff/semanticDiff
    # ------------------------------------------------------------------

    @server.feature("intentumdiff/semanticDiff")
        ...
        try:
            if old_uri == new_uri:
                ...
                if workspace_root is None:
                    return {"error": "intentumdiff/semanticDiff requires a valid workspace root"}
