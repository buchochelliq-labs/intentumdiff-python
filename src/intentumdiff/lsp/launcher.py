...
:class:`~intentumdiff.lsp.client.AsyncLspClient` will execute and manage
...
from intentumdiff.lsp.servers import KNOWN_SERVER_SPECS, LspServerSpec
...
async def _wait_for_port(host: str, port: int, *, timeout: float) -> None:
    ...
    Raises :exc:`~intentumdiff.lsp.exceptions.LspConnectionError` if the
...
class LspServerProcess:
    ...
    spec:
        Optional :class:`~intentumdiff.lsp.servers.LspServerSpec` to use
    ...
    async def stop(self) -> None:
        ...
        :class:`~intentumdiff.lsp.client.AsyncLspClient` owns and
