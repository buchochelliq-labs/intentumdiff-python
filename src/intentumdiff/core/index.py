...
from intentumdiff.core.models import ReferenceUsage, SymbolDefinition
...
class SemanticIndex:
    ...
    Usage::
        ...
        # intentumdiff.analysis.cross_file.detect_cross_file_changes(old, new).
    """
